...
function addRow(targetText = "", origins = []) {
  ...
  if (!isDeletionEntry) {
    ...
    path.setAttribute(
      "d",
      "M280-120q-33 0-56.5-23.5T200-200v-520h-40v-80h200v-40h240v40h200v80h-40v520q0 33-23.5 56.5T720-120H280Zm440-600H240v520q0 17 11.5 28.5T280-200h440q17 0 28.5-11.5T760-200v-520ZM360-280h80v-360h-80v360Zm160 0h80v-360h-80v360ZM240-720v520-520Z",
    );
